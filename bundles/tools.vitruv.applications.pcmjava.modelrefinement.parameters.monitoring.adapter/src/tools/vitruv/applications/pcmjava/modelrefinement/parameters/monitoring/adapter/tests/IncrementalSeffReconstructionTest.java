package tools.vitruv.applications.pcmjava.modelrefinement.parameters.monitoring.adapter.tests;
...
public class IncrementalSeffReconstructionTest extends Java2PcmTransformationTest {
    ...
    public void beforeTest() {
        ...
        try {
        	...
        	fail("Exception during model creationg: " + t.getMessage());
        }
    ...
    public void testAddIfStatementContainingExternalCall() throws Throwable {
        ...
        final GuardedBranchTransition bt = SeffFactory.eINSTANCE.createGuardedBranchTransition();
    ...
    public void testSwitchContainingExternalCall() throws Throwable {
        ...
        final ResourceDemandingBehaviour behaviourForDefaultCase = this
                .createResourceBehaviourWithAbstractActions(SeffFactory.eINSTANCE.createInternalAction());
        final BranchAction ba = SeffFactory.eINSTANCE.createBranchAction();
        final AbstractBranchTransition btCase1 = SeffFactory.eINSTANCE.createGuardedBranchTransition();
        final AbstractBranchTransition btCase2 = SeffFactory.eINSTANCE.createGuardedBranchTransition();
        final AbstractBranchTransition btCase3 = SeffFactory.eINSTANCE.createGuardedBranchTransition();
        final AbstractBranchTransition btCase4 = SeffFactory.eINSTANCE.createGuardedBranchTransition();
        final AbstractBranchTransition btDefaultCase = SeffFactory.eINSTANCE.createGuardedBranchTransition();
    ...
    private ResourceDemandingSEFF editMethod(final String code, final String compilationUnitName,
        ...
        JavaRoot jamoppCu = this.getJaMoPPRootForVURI(VURI.getInstance(iCu.getResource()));
        
        JaMoPPUtil.initialize();
		ResourceSet rs = new ResourceSetImpl();
		Resource resource = rs.createResource(URI.createURI(jamoppCu.getName() + ".java"));
		resource.getContents().add(jamoppCu);
