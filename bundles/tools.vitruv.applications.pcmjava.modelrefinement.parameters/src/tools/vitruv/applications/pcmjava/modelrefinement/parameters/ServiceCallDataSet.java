...
/**
 * The monitoring data of service calls. Every time a service is called a
 * {@link ServiceCall} record is stored.
 * 
 * @author JP
 *
 */
public interface ServiceCallDataSet {
	 ...
	 * @param serviceExecutionId The unique service execution ID.
	 ...
	 * @param externalCallId The id of a an external call.
	 ...
	 * @param serviceId The SEFF ID for a service.
