...
public class A {
	...
	public int methodA(int a) {
		...
		try {
			...
			// Monitoring actions start
			ThreadMonitoringController.getInstance().logResponseTime("_OkrUMMjSEeiWRYm1yDC5rQ", "_oro4gG3fEdy4YaaT-RYrLQ", ___startTime_1);
			// Monitoring actions end
			...
			for (int i = 0; i < a; i++) {
				...
				// Monitoring actions start
				ThreadMonitoringController.getInstance().logResponseTime("_dhstIMjSEeiWRYm1yDC5rQ", "_oro4gG3fEdy4YaaT-RYrLQ", ___startTime_2);
				// Monitoring actions end
				...
				// Monitoring actions start
				ThreadMonitoringController.getInstance().logBranchExecution("_VTWLoMjSEeiWRYm1yDC5rQ", ___executedBranchId_1);
				// Monitoring actions end
			}
			
			// Monitoring actions start
			ThreadMonitoringController.getInstance().logLoopIterationCount("_SSitEMjSEeiWRYm1yDC5rQ", ___loopIterationsCount_1);
			// Monitoring actions end
